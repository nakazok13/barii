...
setInterval(() => {
  http.get(`http://bariii.glitch.me/`); //تعديل مهم حط اسم المشروع
}, 280000);
...
const GUILDID = '692010433371963445'; //  تعديل مهم ايدي السيرفر  
const CHANNELID = '757249630785372280'; // تعديل مهم ايدي الروم الصوتي

//البرفكس
const prefix = "ba"; // تعديل مهم حط هنا البرفكس او مقدمة الامر
...
//تغير الحالة
const developers = ["718094368229031966","","",""] ///تعديل مهم حط هنا ايدي اللي بدك يتحكمو بالحالة
...
let cmds = {
  ...
  stop: { cmd: 'stop', a: ['s','ايقاف'] },
  pause: { cmd: 'pause', a: ['p','ايقاف مؤقت'] },
